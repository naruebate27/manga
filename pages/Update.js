    ...
    db.transaction(tx => {
      tx.executeSql(
        ...
        (tx, results) => {
          ...
          console.log('len',len);
          if (len > 0) {
            console.log(results.rows.item(0).fiction_type);
            this.setState({
             user_name:results.rows.item(0).fiction_name,
            });
            this.setState({
             user_contact:results.rows.item(0).fiction_type,
            });
            this.setState({
             user_address:results.rows.item(0).fiction_author,
            });
          }else{
            alert('No user found');
            this.setState({
